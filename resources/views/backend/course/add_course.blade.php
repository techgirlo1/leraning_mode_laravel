        ...
        <div class="basic-form">
            <form method="post"  action="{{route('insert_course')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control input-default " name="desc1"   ></textarea>
                    @error('desc1')
                    <span class="text-danger">{{$message}}</span> 
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-default " name="name2">
                    @error('name2')
                    <span class="text-danger">{{$message}}</span> 
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-default " name="student">
                    @error('student')
                    <span class="text-danger">{{$message}}</span> 
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-default " name="lecture">
                    @error('lecture')
                    <span class="text-danger">{{$message}}</span> 
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label>Skill</label>
                    <textarea class="form-control input-default " name="skill"   ></textarea>
                    @error('skill')
                    <span class="text-danger">{{$message}}</span> 
                    @enderror
                </div>
