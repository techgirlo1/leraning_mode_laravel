...
<div class="card">
    ...
    <div class="card-body">
        <div class="basic-form">
            <form method="post"  action="{{route('insert_home')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-default " name="sub">
                    @error('sub')
                    <span class="text-danger">{{$message}}</span> 
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control input-default " name="tech" id="tech"   ></textarea>
                    @error('tech')
                    <span class="text-danger">{{$message}}</span> 
                    @enderror
                </div>
